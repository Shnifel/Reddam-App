...
class PieChart2State extends State {
  ...
  Widget build(BuildContext context) {
    return Padding(
      padding:
          const EdgeInsets.only(left: 10.0 / 2, bottom: 10.0, right: 10.0 / 2),
      child: Card(
  ...
  List<PieChartSectionData> showingSections() {
    return List.generate(5, (i) {
      ...
      switch (i) {
        ...
        case 4:
          return PieChartSectionData(
            color: const Color.fromARGB(255, 38, 11, 53),
            value: 20,
            title: '20',
            radius: radius,
            titleStyle: TextStyle(
  ...
  Widget build(BuildContext context) {
    return Padding(
      padding: const EdgeInsets.only(
          left: 10.0 / 2, top: 10.0, bottom: 10.0, right: 10.0 / 2),
      child: Card(
        color: primaryColour,
...
class LineChartSample1State extends State<LineChartSample1> {
  ...
  Widget build(BuildContext context) {
    return Padding(
      padding:
          const EdgeInsets.only(right: 10.0 / 2, top: 10.0, left: 10.0 / 2),
      child: AspectRatio(
        aspectRatio: 1,
        child: Card(
          color: secondaryColour,
...
class BarChartSample2State extends State<BarChartSample2> {
  ...
  final Color rightBarColor = primaryColour;
  ...
  Widget build(BuildContext context) {
    return Padding(
      padding:
          const EdgeInsets.only(top: 10.0, left: 10.0 / 2, right: 10.0 / 2),
      child: AspectRatio(
        aspectRatio: 1,
        child: Card(
          color: secondaryColour,
